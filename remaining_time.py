...
print(f"Remaining time is {days} days {hours} hours {minutes} minutes {seconds} seconds")

print("Charges will refill completely at", refill_time.strftime("%Y-%m-%d %H:%M:%S"))
